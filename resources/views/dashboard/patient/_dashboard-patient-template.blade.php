...
@section('content')
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" data-bs-toggle="dropdown" href="#">
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2">{{ $patient->username }}</span>
                    </a>
    ...
    <aside class="sidebar" id="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item">
                @if ($title == 'Dashboard Pasien')
                    <a class="nav-link" href="{{ route('dashboard-patient') }}" style="background-color: #eeeee4">
                    @else
                        <a class="nav-link collapsed" href="{{ route('dashboard-patient') }}">
                @endif
            ...
            <li class="nav-item">
                @if ($title == 'Dashboard Reservasi')
                    <a class="nav-link" href="{{ route('dashboard-patient-reservation') }}"
                        style="background-color: #eeeee4">
                    @else
                        <a class="nav-link collapsed" href="{{ route('dashboard-patient-reservation') }}">
                @endif
            ...
            <li class="nav-item">
                @if ($title == 'Dashboard Konsultasi')
                    <a class="nav-link" href="{{ route('dashboard-patient-consultation') }}"
                        style="background-color: #eeeee4">
                    @else
                        <a class="nav-link collapsed" href="{{ route('dashboard-patient-consultation') }}">
                @endif
            ...
            <li class="nav-item">
                @if ($title == 'Dashboard Penjemputan')
                    <a class="nav-link" href="{{ route('dashboard-patient-evacuation') }}"
                        style="background-color: #eeeee4">
                    @else
                        <a class="nav-link collapsed" href="{{ route('dashboard-patient-evacuation') }}">
                @endif
